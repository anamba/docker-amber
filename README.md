...
services:
  web:
    image: anamba/crystal-amber-dev:0.34
    ports:
...
docker tag anamba/crystal-amber-dev:latest anamba/crystal-amber-dev:0.34.0
docker tag anamba/crystal-amber-dev:latest anamba/crystal-amber-dev:0.34
